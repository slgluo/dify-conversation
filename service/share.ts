...
import { fetchAppInfo as getAppInfo } from '@/app/actions/dify'
import { getAccessToken, getAppCode } from '@/app/components/share/utils'
...
import type { ChatConfig } from '@/app/components/types'
...
export const fetchAppInfo = async () => {
  const accessToken = getAccessToken(getAppCode())
  return await getAppInfo(accessToken) as Promise<AppData>
}
